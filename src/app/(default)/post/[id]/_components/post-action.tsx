...
export const PostAction = ({ isUserAdmin, isHidden, postBelongsToUser, postId }: PostActionProps) => {
					...
					<MenuItems className='w-28'>
						<MenuItemsContent>
							...
							{postBelongsToUser && (
								<>
									<MenuItem>
										<MenuItemLink href={`/post/${postId}/edit`}>Edit</MenuItemLink>
									</MenuItem>
									<MenuItem>
										<MenuItemButton
											onClick={() =>
	...
	return (
		<>
			<AlertDialogContent>
				...
				<AlertDialogDescription className='mt-6'>Are you sure you want to delete this post?</AlertDialogDescription>
	...
	return (
		<>
			<AlertDialogContent>
				...
				<AlertDialogDescription className='mt-6'>Are you sure you want to hide this post?</AlertDialogDescription>
				<AlertDialogCloseButton onClick={handleDialogClose} />
			</AlertDialogContent>
			<AlertDialogActions>
				<Button
...
const ConfirmUnhidePostDialog = ({ postId }: { postId: number }) => {
	...
	return (
		<>
			<AlertDialogContent>
				<AlertDialogTitle>Hide post</AlertDialogTitle>
				<AlertDialogDescription className='mt-6'>Are you sure you want to unhide this post?</AlertDialogDescription>
				<AlertDialogCloseButton onClick={handleDialogClose} />
			</AlertDialogContent>
			<AlertDialogActions>
				<Button
