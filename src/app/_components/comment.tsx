...
import { Menu, MenuButton, MenuItemButton, MenuItems, MenuItem, MenuItemsContent } from './menu'
				...
				{commentBelongsToUser && (
					<Menu>
						...
						<MenuItems className='w-28'>
							<MenuItemsContent>
								<MenuItem>
									<MenuItemButton onClick={() => setIsEditing(true)}>Edit</MenuItemButton>
								</MenuItem>
								...
								<MenuItem>
									<MenuItemButton
										onClick={() => {
											handleDialog({
												content: <ConfirmDeleteCommentDialog commentId={comment.id} />,
											})
										}}
									>
										Delete
	...
	return (
		<form className='flex-1' onSubmit={handleSubmit(onSubmit)}>
			...
			<div className='flex gap-4 mt-4'>
				<Button type='submit' isLoading={editCommentMutation.isLoading} loadingChildren='Updating comment'>
					Update comment
				</Button>
...
export const AddCommentForm = ({ postId }: { postId: number }) => {
	...
	return (
		<form className='flex-1' onSubmit={handleSubmit(onSubmit)}>
			...
			/>
			<div className='mt-4'>
				<Button type='submit' isLoading={addCommentMutation.isLoading} loadingChildren='Adding comment'>
					Add comment
				</Button>
			</div>
		</form>
...
const ConfirmDeleteCommentDialog = ({ commentId }: ConfirmDeleteCommentDialogProps) => {
	const router = useRouter()
	...
	return (
		<>
			<AlertDialogContent>
				...
				<AlertDialogDescription className='mt-6'>Are you sure you want to delete this comment?</AlertDialogDescription>
