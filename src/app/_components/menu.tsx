...
export const MenuItemButton = ({ className, ...props }: MenuItemButtonProps) => {
	return (
		<button
			type='button'
			className={classNames('block w-full text-left px-4 py-2 text-sm transition-colors', className)}
			{...props}
		/>
	)
}
...
export const MenuItemLink = ({ className, ...props }: MenuItemLink) => {
	return (
		<Link className={classNames('block w-full text-left px-4 py-2 text-sm transition-colors', className)} {...props} />
	)
}

export const MenuItems = ({ children, className }: { children: React.ReactNode; className?: string }) => {
	return (
