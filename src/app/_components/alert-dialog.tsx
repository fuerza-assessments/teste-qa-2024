...
export const AlertDialogAction = ({ children }: { children: ReactNode }) => {
	return <AlertDialogPrimitive.Action asChild>{children}</AlertDialogPrimitive.Action>
}
...
export const AlertDialogDescription = ({ children, className }: { children: ReactNode; className?: string }) => {
	return <AlertDialogPrimitive.Description className={className}>{children}</AlertDialogPrimitive.Description>
}

export const AlertDialogCloseButton = ({ onClick }: { onClick: () => void }) => {
	return (
