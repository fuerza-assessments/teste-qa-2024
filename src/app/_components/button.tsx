...
const button = cva(
	'inline-flex items-center justify-center font-semibold transition-colors rounded-full focus-ring px-4 text-sm h-8',
	{
		variants: {
			variant: {
				primary: 'text-secondary-inverse bg-secondary-inverse hover:text-primary-inverse hover:bg-primary-inverse',
				secondary: 'border text-primary border-secondary bg-primary hover:bg-secondary',
			},
		},
		defaultVariants: {
			variant: 'primary',
