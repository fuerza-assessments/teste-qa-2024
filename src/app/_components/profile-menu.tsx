...
import { Menu, MenuButton, MenuItem, MenuItemButton, MenuItemLink, MenuItems, MenuItemsContent } from './menu'
...
export const ProfileMenu = ({ session }: { session: Session | null }) => {
	...
	const menuItemClasses = ({ active, className }: { active: boolean; className?: string }) => {
		return classNames(
			{ 'bg-secondary': active },
			className,
