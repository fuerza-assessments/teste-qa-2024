...
export const SuggestionListSelect = ({ suggestions, open, onValueChange, ...props }: SuggestionListProps) => {
	...
	return (
		<Select.Root defaultOpen onValueChange={handleValueChange} open={open} {...props}>
			<Select.Content>
